...
- [ ] **Create GitHub repo** (e.g. `your-org/winkslawncare` or `your-org/winkslawncare-website`).
- [ ] **Add remote and push**:
  ```bash
  ...
  ```
- [ ] **Connect to Netlify (or other host)**: connect repo, build `pnpm build` (or `npm run build`), publish `dist/`.

---

## Content

- [ ] **Contact info (TBD)**: Add phone, email, or contact form URL once decided. Placeholder sections exist on the site.
- [ ] **Service areas**: Confirm copy for “Central Illinois, primarily Champaign area” and add specific towns if desired.
